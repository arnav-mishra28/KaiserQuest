...
const STARS:=[Vector2(18,12),Vector2(55,8),Vector2(95,22),Vector2(148,6),Vector2(190,18),
...
Vector2(300,90),Vector2(355,78),Vector2(410,95),Vector2(455,68)]
...
func _draw()->void:
	...
	if _alpha>0.7:
		for wd in [{"icon":"∑","col":Color("#44aaff"),"lbl":"MATH","x":90.0},
				   {"icon":"A","col":Color("#ffcc44"),"lbl":"LANGUAGES","x":200.0},
				   {"icon":"♪","col":Color("#cc44ff"),"lbl":"MUSIC","x":336.0}]:
			draw_rect(Rect2(wd.x-2,198,80,38),Color(0,0,0,_alpha*0.45))
			draw_rect(Rect2(wd.x-2,198,80,38),wd.col*Color(1,1,1,_alpha*0.45),false,1.5)
			draw_string(fnt,Vector2(wd.x+6,220),wd.icon,HORIZONTAL_ALIGNMENT_LEFT,-1,20,wd.col*Color(1,1,1,_alpha))
			draw_string(fnt,Vector2(wd.x+28,220),wd.lbl,HORIZONTAL_ALIGNMENT_LEFT,-1,10,Color(0.9,0.9,0.9,_alpha))
	...
	draw_string(fnt,Vector2(400,314),"v1.0",HORIZONTAL_ALIGNMENT_LEFT,-1,11,Color(0.3,0.3,0.5,_alpha))
